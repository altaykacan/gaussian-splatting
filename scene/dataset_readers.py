...
class CameraInfo(NamedTuple):
    ...
    gt_depth: np.array = None # adding optional ground truth depth for depth regularization
...
def readDenseCloudSceneInfo(path, images, eval, llffhold=8, use_mask=False, use_gt_depth=False):
    """
