...
def training(
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        if dataset.use_gt_depth and not dataset.use_gt_normal:
            render_pkg = render(
                viewpoint_cam,
                gaussians,
                pipe,
        ...
        elif not dataset.use_gt_depth and dataset.use_gt_normal:
            render_pkg = render(
                viewpoint_cam,
                gaussians,
                pipe,
        ...
        elif dataset.use_gt_depth and dataset.use_gt_normal:
            render_pkg = render(
                viewpoint_cam,
                gaussians,
                pipe,
        ...
        if dataset.use_gt_depth:
            ...
            if dataset.use_inverse_depth:
                ...
                depth = 1 / depth
                gt_depth = (1 / gt_depth).clone() # don't want to change the label, so we clone
            else:
                    ...
                    if tb_writer and (idx < 5):
                        ...
                        if iteration == testing_iterations[0]:
                            ...
                            if viewpoint.gt_depth is not None:
                                ...
                                gt_inv_depth = 1 / (gt_depth + 0.00001)
                                gt_inv_depth_norm = (
